...
// $is_blocked = "yes";
// $member_id = "1";
//   echo $block_button = "<button data-target='#block_modal' data-toggle='modal' class='btn btn-dark btn-xs add-tooltip' data-toggle='tooltip' data-placement='top' title='".translate('block')."' onclick='block(\"".$is_blocked."\", ".$member_id.")'><i class='fa fa-ban'></i></button>
//    ";
//    die();
?>
                ...
                <div class="datatable-wrapper table-responsive">
                    <table id="datatable" class="display compact table table-striped table-bordered">
                        ...
                        <tbody>
                               ...
                               <?php foreach ($all_sponsor as $sponsor): ?>

                                <tr>
                                    <td><?= $sponsor->full_name; ?></td>
                                    <td><?= $this->Crud_model->get_type_name_by_id('gender', $sponsor->gender); ?></td>
                                    ...
                                    <td> <i class="fa fa-rupee"></i> <?= $this->Crud_model->get_type_name_by_id('package', $sponsor->product); ?> <?= $this->Crud_model->get_type_name_by_id('package', $sponsor->product , 'fee'); ?></td>
                                    <td>
