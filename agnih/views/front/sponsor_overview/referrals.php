...
<div class="row widget-social">
    ...
    <div class="col-xl-6 col-md-6">
        ...
        <h4>Referral Details: <?= $sponsor_info->username; ?></h4>
            ...
            <div class="card-body">
                <div class="datatable-wrapper table-responsive">
                    <table id="datatable" class="display compact table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($user_referrals as $referrals): ?>
                                                            
                                <tr>
                                    <td><a href="<?= base_url(); ?>home/sponsor_overview/referrals/<?= $referrals->sponsor_id ?>"><?= $this->Crud_model->get_type_name_by_id('sponsor', $referrals->sponsor_id, 'username'); ?></a></td>
                                    <td><?= $this->Crud_model->get_type_name_by_id('sponsor', $referrals->sponsor_id, 'profile_id'); ?></td>
                                    <td><?= $this->Crud_model->get_type_name_by_id('sponsor', $referrals->sponsor_id, 'full_name'); ?></td>
                                    <td><?= $referrals->created_on; ?></td>
                                    <td><?= $this->Crud_model->get_type_name_by_id('sponsor', $referrals->sponsor_id, 'email'); ?></td>
                                    <td><?= $this->Crud_model->get_type_name_by_id('sponsor', $referrals->sponsor_id, 'mobile_no'); ?></td>
