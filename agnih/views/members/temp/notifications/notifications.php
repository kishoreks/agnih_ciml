  <?php 
   $this->db->limit(10);
  $notifications  = $this->db->get_where('sponsor', array('sponsor_referral_id' => $this->session->userdata('sponsor_id') , 'is_blocked' => 'no'))->result();
    ...
    <div class="dropdown-menu extended animated fadeIn" aria-labelledby="navbarDropdown">
        <ul>
            <li class="dropdown-header bg-gradient p-4 text-white text-left">Notifications
                <a href="<?= base_url(); ?>members/sponsor/all_sponsor" class="float-right btn btn-square btn-inverse-light btn-xs m-0">
                            ...
                            <div class="notification d-flex flex-row align-items-center">
                                <div class="notify-icon bg-img align-self-center">
                                    <div class="bg-type bg-type-md">
                                        <span><?=  translate(substr($spl->full_name, 0,2)); ?></span>
                                    </div>
                                </div>
            ...
            <li class="dropdown-footer">
                <a class="font-13" href="<?= base_url(); ?>members/sponsor/all_sponsor"> View All Notifications
                </a>
            </li>
        </ul>
    </div>
