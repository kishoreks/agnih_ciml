<?php 
 ...
 $this->db->limit(6);
 $tickets = $this->db->get_where('tickets' , array('sponsor_id' => $this->session->userdata('sponsor_id') , 'view_at' => '1' ))->result();
    ...
    <div class="dropdown-menu extended animated fadeIn" aria-labelledby="navbarDropdown">
        <ul>
            <li class="dropdown-header bg-gradient p-4 text-white text-left">Messages
                ...
                <a href="<?= base_url(); ?>members/ticket/open_ticket" class="float-right btn btn-square btn-inverse-light btn-xs m-0">
            ...
            <li class="dropdown-footer">
                <a class="font-13" href="<?= base_url(); ?>members/ticket/open_ticket"> View All messages </a>
            </li>
        </ul>
    </div>
</li>