                            ...
                            <div class="col-md-12 m-b-30">
                                ...
                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                    <div class="page-title mb-2 mb-sm-0">
                                        <h1>
                                            <span class="mr-2 mb-2 mr-sm-0 mb-sm-0 badge badge-pill badge-primary-inverse">
                                        ...
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                <li class="breadcrumb-item">
                                                    <a href="<?= base_url('home'); ?>"><i class="ti ti-home"></i></a>
                                                </li>
                                                <li class="breadcrumb-item">
                                                    Dashboard
                                                </li>
            ...
            <footer class="footer">
                <div class="row">
                    ...
                    <div class="col  col-sm-6 ml-sm-auto text-center text-sm-right">
                        <p>Hand-crafted made with <i class="fa fa-heart text-danger mx-1"></i> by Agnih Software</p>
                    </div>
                </div>
            </footer>
            <!-- end footer -->
