    ...
    <a href="javascript:void(0)" class="nav-link dropdown-toggle " id="navbarDropdown4" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <?php $images = json_decode($profile_image, true); ?>
           <?php if (file_exists('uploads/admin_image/'.$images[0]['thumb'])): ?>
              <img src="<?=base_url()?>uploads/admin_image/<?=$images[0]['thumb']?>" alt="avtar-img">
          <?php else: ?>
    ...
    <div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
        <div class="bg-gradient px-4 py-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="mr-1">
                    <h4 class="text-white mb-0"><?= $this->session->userdata('admin_name'); ?></h4>
                   <!--  <small class="text-white">Henry@example.com</small> -->
                </div>
                <a href="<?= base_url('login/logout'); ?>" class="text-white font-20 tooltip-wrapper" data-toggle="tooltip" data-placement="top" title="" data-original-title="Logout"> <i
                                class="zmdi zmdi-power"></i></a>
            </div>
        </div>
        <div class="p-4">
            <a class="dropdown-item d-flex nav-link" href="<?= base_url(); ?>home/account_settings/profile">
