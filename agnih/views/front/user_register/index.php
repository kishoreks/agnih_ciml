...
<div class="row account-contant">
	...
	<div class="col-md-8 offset-2">
	    <div class="card card-statistics">
	        ...
	        <div class="card-body">
	            <form action="<?= base_url(); ?>home/sponsor_register/register" method="post" autocomplete="off">
	            	  <?php
                        $csrf = array(
	                ...
	                <div class="form-group row">
	                 ...
	                 <div class="form-group row">
	                    ...
	                    <div class="col-sm-10">
	                         ...
	                         <input type="text" id="date_of_birth" name="date_of_birth" class="form-control date-picker-default" placeholder="Date Of Birth" value="<?php if (!empty($form_contents)) {
	                 ...
	                 <div class="form-group row">
	                    ...
	                    <div class="col-sm-10">
	                        <input type="text" class="form-control" id="mobile_no" placeholder="98430*****" name="mobile_no" value="<?php if (!empty($form_contents)) {
                    ...
                    <div class="col-lg-6 col-xl-6 p-20 border-bottom border-xl-bottom-0 border-xl-right">
                        <div class="row align-items-center">
                            <div class="col-xxs-12">
                                <!-- <h4>Car Use</h4> -->
                                <p><i class="ion ion-ios-checkmark-circle text-danger"></i> Sponsor New Register In 1 Min .</p>
                                <p><i class="ion ion-ios-checkmark-circle text-danger"></i> Profile ID Will generate Every Sponsor.</p>
                            </div>
                     ...
                     <div class="col-lg-6 col-xl-6 p-20 border-bottom border-xl-bottom-0 border-xl-right">
                        <div class="row align-items-center">
                            <div class="col-xxs-12">
                               <!--  <h4>Car Use</h4> -->
                                <p><i class="ion ion-ios-checkmark-circle text-danger"></i> Sponsor Will Receive Sms Atomically To Mobile.</p>
                                <p><i class="ion ion-ios-checkmark-circle text-danger"></i> Sponsor will receive Email atomically to a Mail ID.</p>
                            </div>
            ...
            <div class="card-body p-0">
                <div class="row no-gutters">
                    <div class="col-lg-6 col-xl-3 p-20 border-bottom border-xl-bottom-0 border-lg-right">
                        <div class="row align-items-center">
                            <div class="col-xxs-12">
                                <h4> <i class="btn btn-social btn-round text-primary fa fa-facebook"></i> tipslife</h4>
                    ...
                    <div class="col-lg-6 col-xl-3 p-20 border-bottom border-xl-bottom-0 border-xl-right">
                        <div class="row align-items-center">
                            <div class="col-xxs-12">
                                <h4><i class="btn btn-social btn-round text-primary fa fa-twitter"></i> tipslife</h4>
                                <!-- <p>Consectetur ipsum dolor sit amet, adipisicing.</p> -->
                            </div>
