      ...
      <div class="bg-light text-white p-2">
        <div class="row">
          <div class="col-md-2"> 
           ...
           <img src="<?= base_url('home/qrcode/' . $sponsor->profile_id); ?>" class="img-responsive" alt="Image">
          </div>
          <div class="col-md-4 text-right bg-dark pt-2">
            <h6 class="text-white text-center">Sub - Total amount</h6>
            <h3 class="text-center text-white"><i class="fa fa-rupee"></i> <?= $this->Crud_model->get_type_name_by_id('package', $sponsor->product , 'fee');  ?></h3>
          </div>
          ...
          <div class="col-md-3 text-right bg-dark pt-2">
            ...
            <h3 class="text-white"><i class="fa fa-rupee"></i> <?= $this->Crud_model->get_type_name_by_id('package', $sponsor->product , 'fee');  ?></h3>
          </div>
        </div>
      </div>
    </div>
