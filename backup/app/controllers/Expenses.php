...
class Expenses extends CI_Controller {
    ...
    public function manage_expenses($para1 = '', $para2 = '')
    {
    	 if ($this->admin_permission() == FALSE) {
            redirect(base_url() . 'login', 'refresh');
        } 

		$page_data['page'] = "Expenses";
        $page_data['title'] = "Expenses Page || " . $this->system_title;
        $page_data['page_file'] = "expenses/index";
        $this->load->view($this->theme . '/index', $page_data);
    }
	
	public function add_expenses($para1 = '', $para2 = '')
	{
		 if ($this->admin_permission() == FALSE) {
            redirect(base_url() . 'login', 'refresh');
        } 
		...
		$page_data['page'] = "Expenses";
        $page_data['title'] = "Expenses Page || " . $this->system_title;
        $page_data['page_file'] = "expenses/add_expenses";
        $this->load->view($this->theme . '/index', $page_data);
	}
...
/* Location: .//D/Ampps/www/tipslife.in/app/controllers/Expenses.php */
