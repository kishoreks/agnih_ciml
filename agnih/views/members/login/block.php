                            ...
                            <div class="col-sm-6 col-lg-5 col-xl-3  align-self-center order-2 order-sm-1">
                                <div class="d-flex align-items-center h-100-vh">
                                    <div class="login p-50 w-100">
                                        <div class="bg-img">
                                            <img src="<?= base_url(); ?>assets/site_img/nophoto.jpg" class="img-fluid" alt="Clients-01">
                                        </div>
                                        <h4 class="mt-4">Username Has Been Blocked</h4>
                                        <span class="mt-1"><i class="fa fa-lock"></i> Locked</span>
                                        <p class="mt-4 mb-0">You Must Contact Admin To Activate Your Account Contact (+91-988430-988430)</p>
                                       <!--  <div class="input-group my-3">
                                        ...
                                        <p class="mt-4 mb-0">Or sign in as a <a class="text-primary" href="<?= base_url('members_login'); ?>">Different user</a></p>
                                    </div>
                                </div>
                            </div>
