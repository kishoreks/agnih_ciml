            ...
            <div class="col-lg-5 pr_70">
                <div class="job_info">
                    <div class="info_head">
                        ...
                        <h6 class="f_p f_600 f_size_18 t_color3">Unique Elements</h6>
                    </div>
                    <div class="info_item">
                        <h6>Owner:</h6>
                        <p>Droit Theme</p>
