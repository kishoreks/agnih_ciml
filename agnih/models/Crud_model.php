...
class Crud_model extends CI_Model
{
    ...
    function get_by_id($type, $type_id = '')
    {
        if ($type_id != '') {
            $l = $this->db->get_where($type, array(
                $type . '_id' => $type_id
    ...
    // FILE_UPLOAD
    function img_thumb($type, $id, $ext = '.jpg', $width = '512', $height = '512')
    {
        ...
        $config1['maintain_ratio'] = FALSE; // change to true
        $config1['width']          = $width;
    ...
    function select_html($from, $name, $field, $type, $class, $e_match = '', $condition = '', $c_match = '', $onchange = '',$condition_type='single')
    {
     ...
     function select_html2($from, $name, $field, $type, $class, $e_match = '', $condition = '', $c_match = '', $onchange = '',$condition_type='single' , $ids)
    {
        ...
        $return = '<select name="' . $name . '" onChange="' . $onchange . '(this.value,this)" class="' . $class . '" ' . $other . '  data-placeholder="' . $phrase . '" tabindex="2" data-hide-disabled="true" id="mother_tongue">';
        if (!is_array($from)) {
            if ($condition == '') {
                $all = $this->db->get($from)->result_array();
            } else if ($condition !== '') {
                if($condition_type=='single'){
                    ...
                    $this->db->where_in($condition,$c_match.$ids);
                    $all = $this->db->get($from)->result_array();
                }
            }
    ...
    function select_html3($from, $name, $field, $type, $class, $e_match = '', $condition = '', $c_match = '', $onchange = '',$condition_type='single' , $ids)
    {
        ...
        $return = '<select name="' . $name . '" onChange="' . $onchange . '(this.value,this)" class="' . $class . '" ' . $other . '  data-placeholder="' . $phrase . '" tabindex="2" data-hide-disabled="true" id="pre-selected-options3">';
        if (!is_array($from)) {
            if ($condition == '') {
                $all = $this->db->get($from)->result_array();
            } else if ($condition !== '') {
    ...
    function select_html4($from, $name, $field, $type, $class, $e_match = '', $condition = '', $c_match = '', $onchange = '',$condition_type='single' , $ids)
    {
        ...
        $return = '<select name="' . $name . '" onChange="' . $onchange . '(this.value,this)" class="' . $class . '" ' . $other . '  data-placeholder="' . $phrase . '" tabindex="2" data-hide-disabled="true" id="professional_preferences">';
        if (!is_array($from)) {
            if ($condition == '') {
                $all = $this->db->get($from)->result_array();
            } else if ($condition !== '') {
    ...
    function select_html5($from, $name, $field, $type, $class, $e_match = '', $condition = '', $c_match = '', $onchange = '',$condition_type='single' , $ids)
    {
        ...
        $return = '<select name="' . $name . '" onChange="' . $onchange . '(this.value,this)" class="' . $class . '" ' . $other . '  data-placeholder="' . $phrase . '" tabindex="2" data-hide-disabled="true" id="professional_preferences_occupation">';
        if (!is_array($from)) {
            if ($condition == '') {
                $all = $this->db->get($from)->result_array();
            } else if ($condition !== '') {
    ...
    function check_members($table, $username, $password)
    {
        $this->db->select('*');
        $this->db->from($table);
    ...
    public function GetChildId($table_name,$parent_id) 
    {  

        $query = $this->db->get_where($table_name,array('parent_id' => $parent_id));
