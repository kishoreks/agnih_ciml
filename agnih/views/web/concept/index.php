 <section class="breadcrumb_area">
    ...
    <div class="container">
        <div class="breadcrumb_content text-center">
            <h1 class="f_p f_700 f_size_50 w_color l_height50 mb_20">concept</h1>
	    ...
	    <div class="row">
	        <div class="col-lg-4 pr_50">
	            <div class="faq_tab">
	                ...
	                <ul class="nav nav-tabs" id="myTab" role="tablist">
	                    <li class="nav-item">
	                        <a class="nav-link active show" id="purchas-tab" data-toggle="tab" href="#purchas" role="tab" aria-controls="purchas" aria-selected="true">Purchasing Online</a>
	                    </li>
	                    <li class="nav-item">
	        ...
	        <div class="col-lg-8">
	            <div class="tab-content faq_content Cus_acc" id="myTabContent">
	                <div class="tab-pane fade active show" id="purchas" role="tabpanel" aria-labelledby="purchas-tab">
